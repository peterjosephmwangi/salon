  ...
  return (
    <section className="relative py-12 bg-gray-50">
      ...
      <video 
        ...
        loop 
        muted 
        className="absolute top-0 left-0 w-full h-screen object-cover z-0" // Full-screen cover effect
      >
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        ...
        <p className="text-lg text-pink-600 text-center max-w-2xl mx-auto mb-8">
